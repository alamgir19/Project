      ...
      <div class="page-content">        
        ...
        <div class="page-left">
          ...
          <table width="100%" border="0" cellspacing="1" cellpadding="1" id="myTable">
            <thead>
                <tr>
                <td width="5%" valign="top">Woman</td>
                </tr>
              <tr>
                ...
                <td width="32%" valign="top">Link Status</td>
                <td width="13%" valign="top">Posted date</td>
                <td width="14%" valign="top">Action</td>
              </tr>
            </thead>
            <tbody>
              <?php $sqls="SELECT * FROM woman_program WHERE CatId = 4 ORDER BY Id";
		  ...
		  while($rowss=mysql_fetch_array($results)){?>
              ...
              <tr>
                ...
                <td valign="top"><?php if ($rowss['LinkStatus']==1) { echo "Active";}else {  echo "<font color='#FF0000'>Inactive.</font>";}?></td>
                <td valign="top"><?php print $rowss['PostedDate'];?></td>
                <td class="gridDataLeft" valign="top"> <a href="javascript:DelConfirm('<?php echo $view['router']->generate('program-update').'/delete/'.$rowss['Id']; ?>')" class="lnkDelete" title="Delete"><img src="<?php echo $view['assets']->getUrl('bundles/projectbundlefrontend/images/spacer.png') ?>" width="15" height="15" border="0" /></a>   <a href="<?php echo $view['router']->generate('add-program').'/'.$rowss['Id'].'/edit'; ?>" class="lnkEdit" title="Edit"><img src="<?php echo $view['assets']->getUrl('bundles/projectbundlefrontend/images/spacer.png') ?>" width="16" height="16" border="0" /></a></td>
              ...
              <thead>
                <tr>
                <td width="5%" valign="top">Student</td>
                </tr>
              <tr>
                <td width="5%" valign="top">SN</td>
                <td width="4%"><input type="checkbox" name="AllChecked" id="AllChecked" title="Click to all select" onclick="ToggleCheck(frmAddEdit)" /></td>
              ...
              <tbody>
              <?php $sqls="SELECT * FROM woman_program WHERE CatId = 3 ORDER BY Id";
		  //print $_GET['suci'].$sqls;
		  $results=mysql_query($sqls);
		  $i=1; //for function alternateRowColor()
		  ...
		  while($rowss=mysql_fetch_array($results)){?>
              ...
              <thead>
                <tr>
                <td width="5%" valign="top">Parent</td>
                </tr>
              <tr>
                <td width="5%" valign="top">SN</td>
                <td width="4%"><input type="checkbox" name="AllChecked" id="AllChecked" title="Click to all select" onclick="ToggleCheck(frmAddEdit)" /></td>
              ...
              <tbody>
              <?php $sqls="SELECT * FROM woman_program WHERE CatId = 1 ORDER BY Id";
		  //print $_GET['suci'].$sqls;
		  $results=mysql_query($sqls);
		  $i=1; //for function alternateRowColor()
		  ...
		  while($rowss=mysql_fetch_array($results)){?>
              ...
              <thead>
                <tr>
                <td width="5%" valign="top">Teacher</td>
                </tr>
              <tr>
                <td width="5%" valign="top">SN</td>
                <td width="4%"><input type="checkbox" name="AllChecked" id="AllChecked" title="Click to all select" onclick="ToggleCheck(frmAddEdit)" /></td>
              ...
              <tbody>
              <?php $sqls="SELECT * FROM woman_program WHERE CatId = 2 ORDER BY Id";
		  //print $_GET['suci'].$sqls;
		  $results=mysql_query($sqls);
		  $i=1; //for function alternateRowColor()
...
addTableRolloverEffect('myTable2','tableRollOverEffect2','tableRowClickEffect2');
        ...
        <div class="page-right">
          <div class="listmenu">
            ...
            <ul>
              <li><a href="<?php echo $view['router']->generate('add-program').'/0/add'; ?>">+ Add ...</a></li>
            </ul>
          </div> 
        </div>
      </div>
