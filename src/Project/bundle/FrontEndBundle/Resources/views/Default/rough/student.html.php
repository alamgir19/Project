...
<head>
	<meta charset="UTF-8">
	<title>Industrial Training Project-Student</title>
...
<?php include("bundles/projectbundlefrontend/include/inc_head_navigation.php");?>
		...
		<div id="page">
        	...
        	<div class="slideImage"><img src="<?php echo $view['assets']->getUrl('bundles/projectbundlefrontend/images/slides/student.jpg') ?>" width="99.5%" height="440"> </div>
        	
			<div id="contents">
                <div class="commonBox">
                
                		<?php $woman_sql=mysql_query("SELECT* FROM woman_program where CatId = 3 AND InShow=1");
