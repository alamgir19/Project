...
Class FCKeditor
	...
	Public Function CreateHtml( instanceName )
		...
		If IsCompatible() Then
			...
			html = html & "<input type=""hidden"" id=""" & instanceName & """ name=""" & instanceName & """ value=""" & Server.htmEncode( sValue ) & """ style=""display:none"" />"
		...
		Else
			...
			html = "<textarea name=""" & instanceName & """ rows=""4"" cols=""40"" style=""width: " & sWidthCSS & "; height: " & sHeightCSS & """>" & Server.htmEncode( sValue ) & "</textarea>"
