...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'D:/localhost/htdocs/Project/Symfony2Project/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $a = $this->get('assetic.asset_factory');
        $b = $this->get('templating.loader');
        $c = new \Assetic\Cache\ConfigCache('D:/localhost/htdocs/Project/Symfony2Project/app/cache/prod/assetic/config');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_bc91011d5a387af66b5bfd75c8158cc2bde2dde65189d9fd0f4706520f59469a');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_bc91011d5a387af66b5bfd75c8158cc2bde2dde65189d9fd0f4706520f59469a');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_bc91011d5a387af66b5bfd75c8158cc2bde2dde65189d9fd0f4706520f59469a');
        ...
        $d->setProxyDir('D:/localhost/htdocs/Project/Symfony2Project/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('D:/localhost/htdocs/Project/Symfony2Project/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('D:/localhost/htdocs/Project/Symfony2Project/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('D:/localhost/htdocs/Project/Symfony2Project/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'D:/localhost/htdocs/Project/Symfony2Project/app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'D:/localhost/htdocs/Project/Symfony2Project/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'D:/localhost/htdocs/Project/Symfony2Project/app/cache/prod',
            ...
            'session.save_path' => 'D:/localhost/htdocs/Project/Symfony2Project/app/cache/prod/sessions',
            ...
            'router.resource' => 'D:/localhost/htdocs/Project/Symfony2Project/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'D:/localhost/htdocs/Project/Symfony2Project/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => 'D:/localhost/htdocs/Project/Symfony2Project/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'D:/localhost/htdocs/Project/Symfony2Project/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'D:/localhost/htdocs/Project/Symfony2Project/app/cache/prod/doctrine/orm/Proxies',
